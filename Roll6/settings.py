"""
Django settings for Roll6 project.
...
SECRET_KEY = '^wo!))^f9)_l&8(2)ean1j=siw^)5mibaiy(!cpefil+ica5zi'
...
WSGI_APPLICATION = 'Roll6.wsgi.application'
...
STATICFILES_DIRS = (
    ...
    os.path.join(BASE_DIR, 'Roll6','apps','static'),
)
